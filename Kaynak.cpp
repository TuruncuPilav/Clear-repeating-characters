/*
    Queue veri yapısında verilen dizideki tüm yinelenen karakterleri silen C kodunu yazınız. 
    Algoritma, sonuçta yineleme kalmayana kadar bitişik kopyaları sıradan kaldırmaya devam etmelidir.
